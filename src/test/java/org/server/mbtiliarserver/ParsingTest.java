...
public class ParsingTest {
    ...
    void start() throws JsonProcessingException {
        SocketMessage request = new SocketMessage("DDSW12", SocketMessageType.GAME_START, 2L, null);
        System.out.println(objectMapper.writeValueAsString(request));
        ...
        SocketMessage response = new SocketMessage("DDSW12", SocketMessageType.ENTRANCE, 2L, objectMapper.writeValueAsString(params));
        System.out.println(objectMapper.writeValueAsString(response));
    }

    @Test
    void requestVote() throws JsonProcessingException {
        SocketMessage request = new SocketMessage("DDSW12", SocketMessageType.REQUEST_VOTE_PROGRESS, 3L, null);
        System.out.println(objectMapper.writeValueAsString(request));
        SocketMessage response = new SocketMessage("DDSW12", SocketMessageType.REQUEST_VOTE_PROGRESS, 3L, null);
        System.out.println(objectMapper.writeValueAsString(response));
    }

    @Test
    void voteProgress1() throws JsonProcessingException {
        SocketMessage request = new SocketMessage("DDSW12", SocketMessageType.VOTE_PROGRESS, 3L, "true");
        System.out.println(objectMapper.writeValueAsString(request));
        SocketMessage response = new SocketMessage("DDSW12", SocketMessageType.GAME_START, 3L, null);
        System.out.println(objectMapper.writeValueAsString(response));
    }
    ...
    void voteProgress2() throws JsonProcessingException {
        SocketMessage request = new SocketMessage("DDSW12", SocketMessageType.VOTE_PROGRESS, 3L, "true");
        System.out.println(objectMapper.writeValueAsString(request));
        SocketMessage response = new SocketMessage("DDSW12", SocketMessageType.VOTE_LIAR, 3L, null);
        System.out.println(objectMapper.writeValueAsString(response));
    }
